...
| [**Ravenous**](https://github.com/timcastillogill/Ravenous_ReactApp) | A front-end React app that calls from the Yelp API to find businesses by rating near you. <br><br>Solo project<br><br><br>Github repo [here](https://github.com/timcastillogill/Ravenous_ReactApp) | <span style="color:orange">**Languages & Frameworks:** <br>React, Yelp API |</span>
